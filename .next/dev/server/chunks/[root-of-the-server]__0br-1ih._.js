...
async function POST(request) {
    try {
        ...
        let result;
        try {
            result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].$queryRawUnsafe(query);
        } catch (sqlError) {
        ...
        if (!result || result.length === 0) {
            ...
            try {
                const userCheck = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].$queryRawUnsafe(`SELECT * FROM users WHERE username = '${username}'`);
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].$executeRawUnsafe(`INSERT INTO sessions (id, user_id, two_fa_verified, is_admin, created_at) VALUES ('${sessionId}', ${user.id}, 0, ${user.role === 'admin' ? 1 : 0}, datetime('now'))`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0br-1ih._.js.map