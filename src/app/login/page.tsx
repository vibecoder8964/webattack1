  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (data.requires2FA) {
          setTimeout(() => {
            window.location.href = '/admin-panel-x7k9m';
          }, 1500);
        } else {
          setTimeout(() => {
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent pr-10"
              ...
              {success && (
                <div className="bg-emerald-50 border border-emerald-200 text-emerald-700 px-4 py-3 rounded-lg text-sm">
                  {success.message}
                  {success.requires2FA && ' Redirecting to 2FA verification...'}
                  {!success.requires2FA && ' Redirecting to your profile...'}
                </div>
              )}
